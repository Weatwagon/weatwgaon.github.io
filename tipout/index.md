...
*   **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Pujo Street Cafe, 901 Ryan Street, Lake Charles, LA 70601.
...
*   **Website** refers to Tip Out, accessible from [https://code.zackjones.net/tipout](https://code.zackjones.net/tipout)
